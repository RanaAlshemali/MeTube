...
$pm_view = NULL; // Initialize page object first

class cpm_view extends cpm {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["messageID"] <> "") {
				...
				$sReturnUrl = "pmlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "pmlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "pmlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($pm_view)) $pm_view = new cpm_view();
...
var CurrentForm = fpmview = new ew_Form("fpmview", "view");

// Form_CustomValidate event
fpmview.Form_CustomValidate = 
...
fpmview.ValidateRequired = true;
<?php } else { ?>
fpmview.ValidateRequired = false; 
<?php } ?>
...
<?php $pm_view->ExportOptions->Render("body") ?>
<?php
	foreach ($pm_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $pm_view->ShowPageHeader(); ?>
<?php
$pm_view->ShowMessage();
?>
<form name="fpmview" id="fpmview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($pm_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $pm_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="pm">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($pm->title->Visible) { // title ?>
	<tr id="r_title">
		<td><span id="elh_pm_title"><?php echo $pm->title->FldCaption() ?></span></td>
		<td data-name="title"<?php echo $pm->title->CellAttributes() ?>>
<span id="el_pm_title">
<span<?php echo $pm->title->ViewAttributes() ?>>
<?php echo $pm->title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pm->user1->Visible) { // user1 ?>
	<tr id="r_user1">
		<td><span id="elh_pm_user1"><?php echo $pm->user1->FldCaption() ?></span></td>
		<td data-name="user1"<?php echo $pm->user1->CellAttributes() ?>>
<span id="el_pm_user1">
<span<?php echo $pm->user1->ViewAttributes() ?>>
<?php echo $pm->user1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pm->user2->Visible) { // user2 ?>
	<tr id="r_user2">
		<td><span id="elh_pm_user2"><?php echo $pm->user2->FldCaption() ?></span></td>
		<td data-name="user2"<?php echo $pm->user2->CellAttributes() ?>>
<span id="el_pm_user2">
<span<?php echo $pm->user2->ViewAttributes() ?>>
<?php echo $pm->user2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pm->message->Visible) { // message ?>
	<tr id="r_message">
		<td><span id="elh_pm_message"><?php echo $pm->message->FldCaption() ?></span></td>
		<td data-name="message"<?php echo $pm->message->CellAttributes() ?>>
<span id="el_pm_message">
<span<?php echo $pm->message->ViewAttributes() ?>>
<?php echo $pm->message->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pm->timestamp->Visible) { // timestamp ?>
	<tr id="r_timestamp">
		<td><span id="elh_pm_timestamp"><?php echo $pm->timestamp->FldCaption() ?></span></td>
		<td data-name="timestamp"<?php echo $pm->timestamp->CellAttributes() ?>>
<span id="el_pm_timestamp">
<span<?php echo $pm->timestamp->ViewAttributes() ?>>
<?php echo $pm->timestamp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pm->user1read->Visible) { // user1read ?>
	<tr id="r_user1read">
		<td><span id="elh_pm_user1read"><?php echo $pm->user1read->FldCaption() ?></span></td>
		<td data-name="user1read"<?php echo $pm->user1read->CellAttributes() ?>>
<span id="el_pm_user1read">
<span<?php echo $pm->user1read->ViewAttributes() ?>>
<?php echo $pm->user1read->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pm->user2read->Visible) { // user2read ?>
	<tr id="r_user2read">
		<td><span id="elh_pm_user2read"><?php echo $pm->user2read->FldCaption() ?></span></td>
...
<?php echo $pm->user2read->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pm->messageID->Visible) { // messageID ?>
	<tr id="r_messageID">
		<td><span id="elh_pm_messageID"><?php echo $pm->messageID->FldCaption() ?></span></td>
		<td data-name="messageID"<?php echo $pm->messageID->CellAttributes() ?>>
<span id="el_pm_messageID">
<span<?php echo $pm->messageID->ViewAttributes() ?>>
<?php echo $pm->messageID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
