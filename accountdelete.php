...
class caccount_delete extends caccount {
	...
	function Page_Main() {
		...
		if ($this->Recordset = ew_LoadRecordset($sql, $conn)) {
			...
			if (!$res) $this->Page_Terminate("accountlist.php"); // Return to list
		}
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				if ($this->Recordset)
					$this->Recordset->Close();
				$this->Page_Terminate("accountlist.php"); // Return to list
			}
		}
	}
...
var CurrentForm = faccountdelete = new ew_Form("faccountdelete", "delete");
...
faccountdelete.Lists["x_ID"] = {"LinkField":"x_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x_ID","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
faccountdelete.Lists["x_ID"].Options = <?php echo json_encode($account->ID->Options()) ?>;
faccountdelete.Lists["x_permissions"] = {"LinkField":"x_userlevelid","Ajax":null,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
faccountdelete.Lists["x_permissions"].Options = <?php echo json_encode($account->permissions->Options()) ?>;
...
?>
<form name="faccountdelete" id="faccountdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($account_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $account_delete->Token ?>">
<?php } ?>
...
<?php if ($account->ID->Visible) { // ID ?>
		<th><span id="elh_account_ID" class="account_ID"><?php echo $account->ID->FldCaption() ?></span></th>
<?php } ?>
<?php if ($account->username->Visible) { // username ?>
		<th><span id="elh_account_username" class="account_username"><?php echo $account->username->FldCaption() ?></span></th>
<?php } ?>
<?php if ($account->password->Visible) { // password ?>
		<th><span id="elh_account_password" class="account_password"><?php echo $account->password->FldCaption() ?></span></th>
<?php } ?>
<?php if ($account->FristName->Visible) { // FristName ?>
		<th><span id="elh_account_FristName" class="account_FristName"><?php echo $account->FristName->FldCaption() ?></span></th>
<?php } ?>
<?php if ($account->LastName->Visible) { // LastName ?>
		<th><span id="elh_account_LastName" class="account_LastName"><?php echo $account->LastName->FldCaption() ?></span></th>
<?php } ?>
<?php if ($account->_Email->Visible) { // Email ?>
		<th><span id="elh_account__Email" class="account__Email"><?php echo $account->_Email->FldCaption() ?></span></th>
<?php } ?>
<?php if ($account->Gender->Visible) { // Gender ?>
		<th><span id="elh_account_Gender" class="account_Gender"><?php echo $account->Gender->FldCaption() ?></span></th>
<?php } ?>
<?php if ($account->BirthDate->Visible) { // BirthDate ?>
		<th><span id="elh_account_BirthDate" class="account_BirthDate"><?php echo $account->BirthDate->FldCaption() ?></span></th>
<?php } ?>
<?php if ($account->permissions->Visible) { // permissions ?>
		<th><span id="elh_account_permissions" class="account_permissions"><?php echo $account->permissions->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($account->ID->Visible) { // ID ?>
		<td<?php echo $account->ID->CellAttributes() ?>>
<span id="el<?php echo $account_delete->RowCnt ?>_account_ID" class="account_ID">
...
<?php } ?>
<?php if ($account->username->Visible) { // username ?>
		<td<?php echo $account->username->CellAttributes() ?>>
<span id="el<?php echo $account_delete->RowCnt ?>_account_username" class="account_username">
...
<?php } ?>
<?php if ($account->password->Visible) { // password ?>
		<td<?php echo $account->password->CellAttributes() ?>>
<span id="el<?php echo $account_delete->RowCnt ?>_account_password" class="account_password">
<span<?php echo $account->password->ViewAttributes() ?>>
<?php echo $account->password->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($account->FristName->Visible) { // FristName ?>
		<td<?php echo $account->FristName->CellAttributes() ?>>
<span id="el<?php echo $account_delete->RowCnt ?>_account_FristName" class="account_FristName">
...
<?php } ?>
<?php if ($account->LastName->Visible) { // LastName ?>
		<td<?php echo $account->LastName->CellAttributes() ?>>
<span id="el<?php echo $account_delete->RowCnt ?>_account_LastName" class="account_LastName">
...
<?php } ?>
<?php if ($account->_Email->Visible) { // Email ?>
		<td<?php echo $account->_Email->CellAttributes() ?>>
<span id="el<?php echo $account_delete->RowCnt ?>_account__Email" class="account__Email">
...
<?php } ?>
<?php if ($account->Gender->Visible) { // Gender ?>
		<td<?php echo $account->Gender->CellAttributes() ?>>
<span id="el<?php echo $account_delete->RowCnt ?>_account_Gender" class="account_Gender">
...
<?php } ?>
<?php if ($account->BirthDate->Visible) { // BirthDate ?>
		<td<?php echo $account->BirthDate->CellAttributes() ?>>
<span id="el<?php echo $account_delete->RowCnt ?>_account_BirthDate" class="account_BirthDate">
<span<?php echo $account->BirthDate->ViewAttributes() ?>>
<?php echo $account->BirthDate->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($account->permissions->Visible) { // permissions ?>
		<td<?php echo $account->permissions->CellAttributes() ?>>
<span id="el<?php echo $account_delete->RowCnt ?>_account_permissions" class="account_permissions">
<span<?php echo $account->permissions->ViewAttributes() ?>>
<?php echo $account->permissions->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $account_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
faccountdelete.Init();
