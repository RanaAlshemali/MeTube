...
define("EW_PROJECT_NAME", "project6", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{38123081-1D14-4172-B112-FF018854E762}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'N9V9aUk46MCRhaJX', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/project6.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "mysql1.cs.clemson.edu", "port" => 3306, "user" => "MeTube_0cdo", "pass" => "Fakepassword7", "db" => "MeTube_jizm", "qs" => "`", "qe" => "`");
...
// Validate option
define("EW_CLIENT_VALIDATE", FALSE, TRUE);
