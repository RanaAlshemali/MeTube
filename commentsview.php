...
$comments_view = NULL; // Initialize page object first

class ccomments_view extends ccomments {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["commentID"] <> "") {
			$this->RecKey["commentID"] = $_GET["commentID"];
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["commentID"] <> "") {
				...
				$this->commentID->setFormValue($_POST["commentID"]);
...
// Create page object
if (!isset($comments_view)) $comments_view = new ccomments_view();
...
var CurrentForm = fcommentsview = new ew_Form("fcommentsview", "view");

// Form_CustomValidate event
fcommentsview.Form_CustomValidate = 
...
fcommentsview.ValidateRequired = true;
<?php } else { ?>
fcommentsview.ValidateRequired = false; 
<?php } ?>
...
<?php
	foreach ($comments_view->OtherOptions as &$option)
		$option->Render("body");
?>
...
?>
<form name="fcommentsview" id="fcommentsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($comments_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $comments_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="comments">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($comments->commentID->Visible) { // commentID ?>
	<tr id="r_commentID">
		<td><span id="elh_comments_commentID"><?php echo $comments->commentID->FldCaption() ?></span></td>
...
<?php echo $comments->commentID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($comments->content->Visible) { // content ?>
	<tr id="r_content">
		<td><span id="elh_comments_content"><?php echo $comments->content->FldCaption() ?></span></td>
		<td data-name="content"<?php echo $comments->content->CellAttributes() ?>>
<span id="el_comments_content">
<span<?php echo $comments->content->ViewAttributes() ?>>
<?php echo $comments->content->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($comments->username->Visible) { // username ?>
	<tr id="r_username">
		<td><span id="elh_comments_username"><?php echo $comments->username->FldCaption() ?></span></td>
...
<?php echo $comments->username->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($comments->mediaid->Visible) { // mediaid ?>
	<tr id="r_mediaid">
		<td><span id="elh_comments_mediaid"><?php echo $comments->mediaid->FldCaption() ?></span></td>
...
<?php echo $comments->mediaid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($comments->dateCreated->Visible) { // dateCreated ?>
	<tr id="r_dateCreated">
		<td><span id="elh_comments_dateCreated"><?php echo $comments->dateCreated->FldCaption() ?></span></td>
...
<?php echo $comments->dateCreated->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
